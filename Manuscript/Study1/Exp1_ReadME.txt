This folder includes the code and data for the first experiment presented in the manuscript -
...
2. The Data_final_RT.csv includes all data required to run the scripts. This dataset includes the following variables:
...
Epoch: Blocks were combined into Epochs (4 Blocks = 1 Epoch);
