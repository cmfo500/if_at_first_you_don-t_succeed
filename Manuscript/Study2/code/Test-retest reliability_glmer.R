...
#session 1
model1 <- glmer(logRT ~ Probability + (Probability|Participant),data= Session1_Data, family = Gamma,
...
# session 2
model2 <- glmer(logRT ~ Probability + (Probability|Participant),data= Session2_Data, family = Gamma,
               control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=2e5)))
...
#session 3
model3 <- glmer(logRT ~ Probability + (Probability|Participant),data= Session3_Data, family = Gamma,
               control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=2e5)))
...
#all sessions
model.total <- glmer(logRT ~ Probability + (Probability|Participant),data= Data.trimmed, family = Gamma,
                    control=glmerControl(optimizer="bobyqa",optCtrl=list(maxfun=2e5)))
...
write.csv(Res2_cor, "results/correlations.glmer.csv")

write.csv(Res2_p, "results/correlations_pvalues.glmer.csv")
