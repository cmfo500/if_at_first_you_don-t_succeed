...
lapses1 <- cor.test(PVT_trimmed_SH$lapses_Even, PVT_trimmed_SH$lapses_Odd)
...
PVT_Split_half <- data.frame(Measure = c("Lapses", "Mean", "Median", "Reciprocal"),
                             Split.half = round(c(lapses1$estimate, mean_RT1$estimate, median1$estimate, reciprocal1$estimate),3))
