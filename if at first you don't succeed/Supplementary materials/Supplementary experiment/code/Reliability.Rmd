...
lapses <- cor.test(PVT_trimmed$lapses_1, PVT_trimmed$lapses_2, method = "spearman", exact = FALSE, ci = 0.95)

SpearmanRho(PVT_trimmed$lapses_1, PVT_trimmed$lapses_2, use = "pairwise.complete.obs", conf.level = .95)
